...
ActiveRecord::Schema.define(version: 20171219023547) do

  create_table "articles", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.bigint "user_article_id"
    t.string "article"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_article_id"], name: "index_articles_on_user_article_id"
  end
  ...
  add_foreign_key "articles", "user_articles"
